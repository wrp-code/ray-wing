...
## renren-ui
- renren-ui基于vue、element-ui构建开发，实现 renren-security 后台管理前端功能，提供一套更优的前端解决方案
- 前后端分离，通过token进行数据交互，可独立部署
- 动态菜单，通过菜单管理统一管理访问路由
- Gitee后端地址：https://gitee.com/renrenio/renren-security
- GitCode后端地址：https://gitcode.com/renrenio/renren-security
...
- GitCode仓库：https://gitcode.com/renrenio/renren-ui
